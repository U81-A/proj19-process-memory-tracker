        ...
        if (mode == 'a') {
            ...
            while (true) {
                ...
                for (int i = 0; i < result.size(); ++i) {
                    cout << setw(15) << process_list[i].pid << setw(15) << process_list[i].memory << endl;
                }
                usleep(1000000);
            }
            break;
            ...
            while (true) {
                ...
                for (int i = 0; i < result.size(); ++i) {
                    cout << CYAN << setw(5) << i+1 << RESET << setw(15) << process_list[i].pid << setw(15) << process_list[i].memory << endl;
                }
                usleep(1000000);
            }
            break;
